...
import { NEW_REVIEW_RESET } from 'store/constants/roomContants'
...
const NewReview = ({ id }: Props) => {
  ...
  const { error, success } = useSelector((state: NewRev) => state.newReview)
  const { reviewAvailable } = useSelector(
    (state: CheckRev) => state.checkReview
  )
  ...
  function setUserRatings() {
    ...
    function showRatings(e: { type: string }) {
